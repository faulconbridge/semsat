...
semsat1.R contains a simple script to perform a repeated measures ANOVA on the data contained in SemSat1_compiled_csv.csv. SemSat1_compiled_data.xlsx is much the same data, including participant condition means if you prefer to analyze the data in SPSS.
