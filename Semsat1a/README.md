...
###Analyses
semsat1a.R contains a simple script to perform a repeated measures ANOVA on the data contained in SemSat1a\_compiled.csv. SemSat1a\_compiled\_data.xlsx is much the same data, including participant condition means if you prefer to analyze the data in SPSS.
